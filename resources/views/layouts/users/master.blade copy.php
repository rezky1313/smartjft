...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="/library/dist/img/logo-kemenhub.png" alt="AdminLTELogo" height="300" width="300">
  </div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="" class="brand-link">
      <img src="/library/dist/img/logo-kemenhub.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
                ...
                <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <a href="{{ url('user/unitkerja') }}" class="nav-link" onclick="pindah(event)">
                     ...
                     <li class="nav-item">
                    <a href="{{ url('user/unitkerja/create') }}" class="nav-link" onclick="pindah(event)">
                      <i class="nav-icon fas fa-columns"></i>
                      <p>
                        Tambah Data
                      </p>
...
{{-- penting: supaya @push('scripts') dari halaman anak dieksekusi --}}
@stack('scripts')
