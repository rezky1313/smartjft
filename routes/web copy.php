...
//   // Laporan → Jumlah Pemangku
// Route::prefix('laporan')->name('reports.')->group(function () {
//     Route::get('pemangku',        [\App\Http\Controllers\ReportController::class, 'pemangkuIndex'])->name('pemangku.index');
//     Route::get('pemangku/data',   [\App\Http\Controllers\ReportController::class, 'pemangkuData'])->name('pemangku.data');
//     Route::get('pemangku/export', [\App\Http\Controllers\ReportController::class, 'pemangkuExport'])->name('pemangku.export');
// });

// // Dependent dropdown
// Route::get('/wilayah/regencies/{province}', [\App\Http\Controllers\WilayahController::class, 'regencies'])
//     ->name('wilayah.regencies');
// Route::get('/wilayah/units', [\App\Http\Controllers\WilayahController::class, 'units'])
//     ->name('wilayah.units');

  
    //      Route::get('/laporan',       [ReportController::class, 'index'])->name('reports.index');
    //      Route::get('/laporan/data',  [ReportController::class, 'data'])->name('reports.data');
   ...
   // A. canonical route with params
    ...
    Route::post('formasi/update-group',
        ...
        Route::get   ('rumahsakit/trash',            [RumahsakitController::class,'trash'])->name('rumahsakit.trash');
        Route::patch ('rumahsakit/{id}/restore',     [RumahsakitController::class,'restore'])->name('rumahsakit.restore');
        Route::delete('rumahsakit/{id}/force',       [RumahsakitController::class,'forceDelete'])->name('rumahsakit.force-delete');
